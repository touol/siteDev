...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        ...
        $out .= '<h3>Modstore</h3>';
        $out .= 'Введите данные для подключения к Modstore.pro:<br/>
            <div id="modx-modstore" style="width: auto;">
                <label for="email">Имя пользователя</label><br>
                <input type="text" id="email" name="email" class="x-form-text x-form-field"/><br>
                <label for="key">Ключ API</label><br>
                <input type="text" id="key" name="key" class="x-form-text x-form-field"/> 
            </div>
        ';
        break;
}
